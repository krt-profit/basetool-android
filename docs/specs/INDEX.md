...
| [`settings.md`](settings.md) (`REQ-APP-SET-*`) — **exists** (`001`–`007`) | Einstellungen screen scope, per-app language, string-resource rule, legal links, the generated open-source notice |

...
| [`ui.md`](ui.md) (`REQ-APP-UI-*`) — **exists** (`001`–`002`) | cross-screen behaviour: pull-to-refresh reaching an empty screen, and a bottom sheet keeping its actions out of the gesture bar. Still to come: KRT design tokens, adaptive layout rules, i18n + copy rules, Fan Kit compliance band (see `core/designsystem/fankit/`) — extracted from the binding design spec at `docs/design/android/` |

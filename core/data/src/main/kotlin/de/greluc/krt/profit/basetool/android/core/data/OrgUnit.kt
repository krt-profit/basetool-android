...
enum class OrgUnitKind {
    ...
    /**
     * A kind this build does not know (`REQ-APP-API-005`); the unit is still offered, only its
     * grouping is unknown.
     */
    UNKNOWN,
}
 ...
 * @property profitEligible whether the unit may process orders; `false` when the server did not
 *   say.
 */
data class OrgUnit(
    val id: String,
